// Automatically load all existing shipments into the table when the page opens
        ...
        tableBody.innerHTML += `
            <tr style="border-bottom: 1px solid #f1f5f9;">
                ...
                <td style="padding: 12px;">
                    <button onclick="updateStatusPrompt('${shipment.tracking_number}')" style="background: #0284c7; color: #white; border: none; padding: 6px 12px; border-radius: 4px; cursor: pointer; color: #fff;">Update</button>
                </td>
            </tr>
        `;
    });
